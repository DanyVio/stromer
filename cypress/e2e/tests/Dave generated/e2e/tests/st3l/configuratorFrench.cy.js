...
describe('Bike Configurator', function () {
  ...
  //Select an ST3l E-bike

  it('Your Stromer -> ST3l', function () {
    cy.visit(`${config.baseUrl}`+'/fr/configurator?bike=st3l');
    ...
    cy.get('[for="Rahmengrösse_m0"]')
      .should('be.visible')
      .click();
    cy.get('#bikepreviewimg').should('have.prop', 'src', 'https://www.stromerbike.com/bike-configurator/img/bikes/st3lsbspm0.jpg');

    cy.get('[for="Rahmengrösse_xl"]')
      .should('be.visible')
      .click();
    cy.get('#bikepreviewimg').should('have.prop', 'src', 'https://www.stromerbike.com/bike-configurator/img/bikes/st3lsbspxl.jpg');
    ...
    cy.get('#upgradeOptionf2').should('be.visible');
    cy.get('#upgradeOptionf2 > .upgradeOptionImg > img').should('have.prop', 'src', 'https://www.stromerbike.com/bike-configurator/img/upgrade/f2.jpg');
